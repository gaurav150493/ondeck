...
export const post: BlogPost = {
  slug: "cost-to-start-online-casino",
  title: "How Much Does It Cost to Start an Online Casino?",
  heading: "How Much Does It Cost to Start an Online Casino? A 2027 Breakdown",
  ...
  image: "/images/news/cost-to-start-online-casino-photo.webp",
  author: "Ellen Tilly",
  ...
  faq: [
    { question: "What is the cheapest way to start an online casino?", answer: "A white-label platform operating under the provider’s licence. It has the lowest up-front cost and fastest launch, at the price of an ongoing revenue share and less control." },
